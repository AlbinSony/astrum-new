              ...
              <div className="rounded-2xl bg-white p-4 sm:p-6 shadow-lg ring-1 ring-gray-900/5 hover:shadow-xl transition-shadow">
                <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-4">
                  <div className="flex items-start gap-4 flex-1">
                    <div className="flex h-10 w-10 sm:h-12 sm:w-12 items-center justify-center rounded-xl bg-astrum text-white flex-shrink-0">
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <div className="space-y-2">
                        <div className="flex items-center text-xs sm:text-sm text-primary-700">
                          <FaCalendarAlt className="mr-2 h-3 w-3 sm:h-4 sm:w-4 text-primary-400 flex-shrink-0" />
                          <span className="truncate">{event.date}</span>
                        </div>
                        
                        <div className="flex items-center text-xs sm:text-sm text-primary-700">
                          <FaClock className="mr-2 h-3 w-3 sm:h-4 sm:w-4 text-primary-400 flex-shrink-0" />
                  ...
                  <button className="w-full sm:w-auto sm:ml-6 bg-astrum text-white px-4 sm:px-6 py-2 rounded-lg hover:bg-astrum-dark transition-colors text-sm sm:text-base font-medium">
                    Register Now
                  </button>
                </div>
              </div>
            ...
            <FadeIn key={benefit}>
              <div className="rounded-xl bg-neutral-50 p-6">
                <div className="flex items-center">
                  <div className="mr-3 h-2 w-2 rounded-full bg-astrum" />
                  <span className="font-medium text-primary-900">{benefit}</span>
                </div>
              </div>
            </FadeIn>
          ))}
          ...
          <div className="rounded-3xl bg-astrum-gradient px-6 py-20 sm:px-6 sm:py-32 md:px-12">
            <div className="mx-auto max-w-4xl text-center">
              ...
              <div className="mt-8">
                <a
                  href="/contact"
                  className="inline-flex rounded-full bg-white px-8 py-3 text-sm font-semibold text-primary-900 transition hover:bg-green-50"
                >
                  Reserve Your Seat
                </a>
              </div>
