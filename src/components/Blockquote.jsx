...
function BlockquoteWithImage({ author, image, children, className }) {
  return (
    ...
    >
      <blockquote className="col-span-2 text-xl/7 text-primary-700 sm:col-span-7 sm:col-start-6 sm:row-start-2">
        {typeof children === "string" ? <p>{children}</p> : children}
      </blockquote>
      <div className="col-start-1 row-start-2 overflow-hidden rounded-xl bg-green-50 sm:col-span-5 sm:row-span-full sm:rounded-3xl">
        <Image
          alt=""
          {...image}
      ...
      <figcaption className="text-sm text-primary-900 sm:col-span-7 sm:row-start-3 sm:text-base">
